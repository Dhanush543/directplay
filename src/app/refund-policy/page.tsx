...
export const metadata: Metadata = {
    title: "Refund Policy – DirectPlay",
    description: "Our 7-day refund guarantee and how it works.",
...
export default function RefundPolicyPage() {
    const data = legalContent.refundPolicy;

    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "WebPage",
        name: "Refund Policy – DirectPlay",
        url: `${siteUrl}/refund-policy`,
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="mx-auto max-w-5xl">
                <article className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 md:p-10 shadow-sm">
                    <h2 className="text-base font-semibold">7-day guarantee</h2>
